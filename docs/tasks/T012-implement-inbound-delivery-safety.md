...
claim_expires_at:
write_set:
  - src/police_peer/transport/inbox.py
...
- `uv run ruff check src/police_peer/transport/inbox.py tests/unit/transport/test_inbox.py tests/integration/test_delivery_faults.py`
