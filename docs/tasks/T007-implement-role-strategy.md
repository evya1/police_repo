...
- [ ] The Police objective is explicit: use belief to pursue, choose between legal movement and barrier placement, and issue capture claims only when locally justified.
